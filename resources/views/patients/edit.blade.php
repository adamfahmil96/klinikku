        ...
        <form action="{{ route('patients.update', $patient->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea id="address" name="address" rows="3"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">{{ $patient->address }}</textarea>
            </div>
